// ----------------------------------------------------------------------------------
// ambiente_imagenapp_rest.ctrl.js
// ----------------------------------------------------------------------------------
    ...
    if(datos.length>0){
       ...
       xmlhttp.onreadystatechange = function() {
           if (this.readyState == 4 && this.status == 200) {
               ...
               if(obResultado[0]["retorno"]=="TRUE"){
                    console.log("correcto");       
                    document.getElementById("lbl_mensaje_exitoso").innerHTML="ELIMINACION EXITOSA";
...
function Consultar_Imagen(datos){    
    if(datos.length>0){
        ob = JSON.stringify(datos);

        var xmlhttp = new XMLHttpRequest();
        var url = UBICACION_CONTROL + "/ambiente_imagenapp_consultar.ctrl.php";
                   ...
                   if(obResultado[i]["retorno"]=="TRUE"){ 
                       ...
                       for (var campo in obResultado[i]) {
                            ...
                            if(campo=="Imagen" ){
                                ...
                                var l_NomArchivo = obResultado[i][campo];
