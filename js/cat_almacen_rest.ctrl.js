...
function Cat_Almacen_Combo_Origen(datos){ 
    ...
    if(datos.length>0){
        ...
        xmlhttp.onreadystatechange = function() {
            if (this.readyState == 4 && this.status == 200) {
                ...
                document.getElementById("cb_nIDCat_Almacen_Origen").innerHTML=l_Registros;  
                // ----------------------------------------------------------------             
...
function Cat_Almacen_Combo_Destino(datos){ 
    ...
    if(datos.length>0){
        ...
        xmlhttp.onreadystatechange = function() {
            if (this.readyState == 4 && this.status == 200) {
                ...
                document.getElementById("cb_nIDCat_Almacen_Destino").innerHTML=l_Registros;  
                // ----------------------------------------------------------------             
...
function Cat_Almacen_Combo_Inspeccion(datos){ 
