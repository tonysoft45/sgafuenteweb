// ----------------------------------------------------------------------------------
// cat_centrosdeservicio_rest.ctrl.js
// ----------------------------------------------------------------------------------
...
function Cat_CentrosDeServicio_Combo(datos){         
    if(datos.length>0){
        ...
        var xmlhttp = new XMLHttpRequest();        
        var url = UBICACION_CONTROL + "/cat_centrosdeservicio_consultar.ctrl.php";
        ...
        xmlhttp.onreadystatechange = function() {
           if (this.readyState == 4 && this.status == 200) {
             ...
             for(i=0;i<registros.length;i=i+1){
               ...
               document.getElementById("cb_nIDCat_CentroDeServicio").innerHTML=l_Registros;  
               // ----------------------------------------------------------------             
