...
function Cat_Clientes_Combo(datos){ 
    ...
    if(datos.length>0){
        ...
        var xmlhttp = new XMLHttpRequest();
        var url = UBICACION_CONTROL + "/cat_clientes_consultar.ctrl.php";
        ...
        xmlhttp.onreadystatechange = function() {
            if (this.readyState == 4 && this.status == 200) {
                ...
                document.getElementById("cb_nIDCat_Cliente").innerHTML=l_Registros;  
                // ----------------------------------------------------------------             
