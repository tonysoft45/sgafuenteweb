// ----------------------------------------------------------------------------------
// cat_conceptossalida_rest.ctrl.js
// ----------------------------------------------------------------------------------
...
function Cat_ConceptosSalida_Combo(datos){ 

    if(datos.length>0){
        var nID=datos[0]["seleccion"];
        var Accion=datos[0]["accion"];

        if(Accion=="Eliminar" || Accion=="Detalles"){
            return;
        }
        ...
        var xmlhttp = new XMLHttpRequest();
        var url = UBICACION_CONTROL + "/cat_conceptossalida_consultar.ctrl.php"; 
        ...
        xmlhttp.onreadystatechange = function() {
            if (this.readyState == 4 && this.status == 200) {
               ...
               // Construye la respuesta
                ...
                document.getElementById("cb_nIDCat_ConceptoSalida").innerHTML=l_Registros;  
                // ----------------------------------------------------------------             
