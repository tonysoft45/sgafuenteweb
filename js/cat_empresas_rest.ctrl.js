...
function Cat_Empresa_Combo(datos){         
    if(datos.length>0){
        ...
        var xmlhttp = new XMLHttpRequest();
        var url = UBICACION_CONTROL + "/cat_empresas_consultar.ctrl.php";
        ...
        xmlhttp.onreadystatechange = function() {
           if (this.readyState == 4 && this.status == 200) {
               ...
               document.getElementById("cb_nIDCat_Empresa").innerHTML=l_Registros;  
               // ----------------------------------------------------------------             
