...
function Cat_Estados_Combo(datos){ 
    ...
    if(datos.length>0){
        ...
        var xmlhttp = new XMLHttpRequest();
        var url = UBICACION_CONTROL + "/cat_estados_consultar.ctrl.php";
        ...
        xmlhttp.onreadystatechange = function() {
            if (this.readyState == 4 && this.status == 200) {
               ...
               // Construye la respuesta
                ...
                document.getElementById("cb_nIDCat_Estado").innerHTML=l_Registros;  
                // ----------------------------------------------------------------             
