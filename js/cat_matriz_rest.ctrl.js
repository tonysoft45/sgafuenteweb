           ...
           if (this.readyState == 4 && this.status == 200) {
               ...
               for(i=0;i<contador;i++){     
                   ...
                   if(obResultado[i]["retorno"]=="TRUE"){ 
                        ...
                        l_nIDCat_Pasillo=obResultado[i]["nIDCat_Pasillo"];
                        l_nIDCat_Rack=obResultado[i]["nIDCat_Rack"];
               ...
               fn_Cat_Almacen_Clic('',l_nIDCat_Almacen,l_Accion);     
               fn_Cat_Pasillos_Clic('',l_nIDCat_Pasillo,l_Accion);   
               fn_Cat_Rack_Clic('',l_nIDCat_Rack,l_Accion);   
...
function Cat_Matriz_Combo(datos){ 
    ...
    if(datos.length>0){
        ...
        var xmlhttp = new XMLHttpRequest();
        var url = UBICACION_CONTROL + "/cat_matriz_consultar.ctrl.php";
        ...
        xmlhttp.onreadystatechange = function() {
            if (this.readyState == 4 && this.status == 200) {
                ...
                document.getElementById("cb_nIDCat_Matriz").innerHTML=l_Registros;  
                // ----------------------------------------------------------------             
