...
function Cat_Productos_Combo(datos){ 
    ...
    if(datos.length>0){
        ...
        var xmlhttp = new XMLHttpRequest();
        var url = UBICACION_CONTROL + "/cat_productos_consultar.ctrl.php";
        ...
        xmlhttp.onreadystatechange = function() {
            if (this.readyState == 4 && this.status == 200) {
                ...
                document.getElementById("cb_nIDCat_Producto").innerHTML=l_Registros;  
                // ----------------------------------------------------------------             
    ...
    if(datos.length>0){
        ...
        xmlhttp.onreadystatechange = function() {
           if (this.readyState == 4 && this.status == 200) {
               ...
               var l_Tipo="";
               var l_nIDCat_Tipo=0;
               var l_nIDCat_SubTipo=0;
               var l_nIDCat_Familia=0;
               var l_nIDCat_Presentacion=0;
               var l_nIDCat_Excepcion=0;
               var l_nIDCat_UnidadDeMedida=0;
               var l_nIDCat_Proveedor=0;
               ...
               for(i=0;i<contador;i++){     
                   ...
                   if(obResultado[i]["retorno"]=="TRUE"){ 
                        ...
                        l_nIDCat_Tipo=obResultado[i]["nIDCat_Tipo"];
                        l_nIDCat_SubTipo=obResultado[i]["nIDCat_SubTipo"];
                        l_nIDCat_Familia=obResultado[i]["nIDCat_Familia"];
                        l_nIDCat_Presentacion=obResultado[i]["nIDCat_Presentacion"];
                        l_nIDCat_Excepcion=obResultado[i]["nIDCat_Excepcion"];
                        l_nIDCat_UnidadDeMedida=obResultado[i]["nIDCat_UnidadDeMedida"];
                        l_nIDCat_Proveedor=obResultado[i]["nIDCat_Proveedor"];
               ...
               fn_Cat_Tipos_Clic('',l_nIDCat_Tipo,l_Accion);     
               fn_Cat_SubTipos_Clic('',l_nIDCat_SubTipo,l_Accion);   
               fn_Cat_Familias_Clic('',l_nIDCat_Familia,l_Accion);   
               fn_Cat_Presentaciones_Clic('',l_nIDCat_Presentacion,l_Accion);   
               fn_Cat_Excepciones_Clic('',l_nIDCat_Excepcion,l_Accion);   
               fn_Cat_UnidadesDeMedida_Clic('',l_nIDCat_UnidadDeMedida,l_Accion);   
               fn_Cat_Proveedores_Clic('',l_nIDCat_Proveedor,l_Accion);   
