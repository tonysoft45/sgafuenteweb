            ...
            if (this.readyState == 4 && this.status == 200) {
                ...
                for(i=0;i<contador;i++){     
                    ...
                    if(obResultado[i]["retorno"]=="TRUE"){ 
                        ...
                        l_Registros=l_Registros + "<label style='cursor:pointer;' >" +   l_Carton + "</label>";
                        ...
                        l_Registros=l_Registros + "<div class='col d-flex justify-content-middle align-items-center' style='text-align:center; font-size:8px; vertical-aling:middle;display:block; cursor:pointer;'>";
                        ...
                        for (var campo in obResultado[i]) {
                            ...
                            if(campo!="retorno" && campo!="msg" && campo!="llave" && campo!="especiales" && campo!="combo" ){
                                if(l_Llave==campo){
                                    ...
                                    if(campo.toLowerCase()=="codigo"){
                                        if(l_Estatus=="RECIBO"){
                                            l_Registros=l_Registros + "<div class='col d-flex justify-content-start align-items-left' style='text-align:center; font-size:8px; vertical-aling:middle;display:block; cursor:pointer; background-color:#00FF00;'>";
                                        } else {
                                            l_Registros=l_Registros + "<div class='col d-flex justify-content-start align-items-left' style='text-align:center; font-size:8px; vertical-aling:middle;display:block; cursor:pointer; '>";
                                        }
