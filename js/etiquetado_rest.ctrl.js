           ...
           if (this.readyState == 4 && this.status == 200) {
               ...
               if(obResultado[0]["retorno"]=="TRUE"){               
                    ...
                    for(i=0;i<contador;i++){     
                        ...
                        if(l_Estatus=="ETIQUETADO"){
                            l_Linea=l_Linea  + "<a class='nav-link' href='" + MODULO + "_editar.php?id=" + obResultado[i]["nIDPackingList"] +"&accion=Detalles' style='font-size:12px; color: #53BEFE;cursor:pointer; margin-left: -15px; margin-right: -20px;font-weight:bold; '>Reimprimir </a>"                                    
                        } else {
                            l_Linea=l_Linea  + "<a class='nav-link' href='" + MODULO + "_editar.php?id=" + obResultado[i]["nIDPackingList"] +"&accion=Detalles' style='font-size:12px; color: #53BEFE;cursor:pointer; margin-left: -15px; margin-right: -20px;font-weight:bold; '>Imprimir </a>"                                    
                        }
...
function fn_Encima(i,actividad){
    var registro = document.getElementById("id_r"+i);
