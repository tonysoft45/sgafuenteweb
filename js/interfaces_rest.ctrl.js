    ...
    if(datos.length>0){
        ...
        xmlhttp.onreadystatechange = function() {
           if (this.readyState == 4 && this.status == 200) {
               ...
               // Modulos
               fn_Ambiente_Modulos_Clic('',l_nIDModulo,l_Accion );
...
function Interfaces_Combo(datos){ 
    ...
    if(datos.length>0){
        ...
        xmlhttp.onreadystatechange = function() {
           if (this.readyState == 4 && this.status == 200) {
               ...
               document.getElementById("cb_nIDInterfaz").innerHTML=l_Registros;  
