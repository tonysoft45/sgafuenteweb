...
function fn_Ver_Detalles(l_nIDIxA_Deta, l_nIDIxA, l_nIDProducto, l_Codigo, l_Producto, l_UnidadDeMedida, l_Estado, l_Existencia, l_Conteo, l_Diferencia, l_Estado){
    ...
    l_Linea=l_Linea + "<div class='col-md-4 d-flex justify-content-left align-items-center w-20' style='height: 40px; text-align:center; font-size:10px; font-family:Arial black, Gadget, sans-serif;vertical-aling:middle;display:block; cursor:pointer;background-color:#F4F5F5;'>";
    ...
    l_Linea=l_Linea + "<div class='col-md-1 d-flex justify-content-left align-items-center w-13' style='height: 40px;text-align:center; font-size:10px; font-family:Arial black, Gadget, sans-serif;vertical-aling:middle;display:block; cursor:pointer;background-color:#F4F5F5;'>";
    l_Linea=l_Linea + "   <label style='cursor:pointer;' > Dif </label>";
    l_Linea=l_Linea + "</div>";
    ...
    for(i=0;i<listadodeproductos.length;i++){
        ...
        //l_Linea=l_Linea + "<div class='col justify-content-start align-items-left w-3 d-inline-block' style='text-align:left; font-size:8px; vertical-aling:middle;display:block; cursor:pointer; background-color:#ccc; width:10px;'>";
        ...
        l_Linea=l_Linea + "<div class='col-md-4  justify-content-start align-items-left w' style='text-align:left; font-size:8px; vertical-aling:middle;display:block; cursor:pointer;'>";
...
function fn_Agregar(l_nIDIxA_Deta, l_nIDIxA, l_nIDProducto, l_Codigo_IZeta, l_Producto, l_UnidadDeMedida, l_nIDCat_Estado, l_Estado, l_Cantidad, l_nIDUsuario, l_Existencia){
    ...
    if(l_UnidadDeMedida.length<=0){
        l_UnidadDeMedida="Sin unidad"
    }
    ...
    for(i=0;i<listadodeproductos.length;i++){
        ...
        l_Linea=l_Linea + "<div class='col-md-2 d-flex justify-content-start align-items-left' style='text-align:center; font-size:8px; vertical-aling:middle;display:block; cursor:pointer;'>";
        l_Linea=l_Linea + "<label style='cursor:pointer;' >" +   listadodeproductos[i]["estado"] + "</label>";
        l_Linea=l_Linea + "</div>";   
...
function Ajustar_Inventario(datos){    
    if(datos.length>0){         
        ...
        var xmlhttp = new XMLHttpRequest();
        var url = UBICACION_CONTROL + "/inventarioxarticulo_ajustar.ctrl.php";
