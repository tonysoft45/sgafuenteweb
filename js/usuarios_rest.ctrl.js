           ...
           if (this.readyState == 4 && this.status == 200) {
               ...
               for(i=0;i<contador;i++){     
                   ...
                   if(obResultado[i]["retorno"]=="TRUE"){ 
                        l_nIDPerfil=obResultado[i]["nIDPerfil"];
               ...
               fn_Perfiles_Clic('',l_nIDPerfil,l_Accion);        
           }        
        };
...
function Usuarios_Combo(datos){ 
    ...
    if(datos.length>0){
        ...
        var xmlhttp = new XMLHttpRequest();
        var url = UBICACION_CONTROL + "/usuarios_consultar.ctrl.php";
        ...
        xmlhttp.onreadystatechange = function() {
            if (this.readyState == 4 && this.status == 200) {
                ...
                document.getElementById("cb_nIDUsuario").innerHTML=l_Registros;  
                // ----------------------------------------------------------------             
...
function Comprador_Combo(datos){ 
    ...
    if(datos.length>0){
        ...
        xmlhttp.onreadystatechange = function() {
            if (this.readyState == 4 && this.status == 200) {
                ...
                document.getElementById("cb_nIDComprador").innerHTML=l_Registros;  
                // ----------------------------------------------------------------             
...
function Usuarios_Nombre(datos){ 
    if(datos.length>0){
        ob = JSON.stringify(datos);

        var xmlhttp = new XMLHttpRequest();
        var url = UBICACION_CONTROL + "/usuarios_consultar_todos.ctrl.php";
        ...
        xmlhttp.onreadystatechange = function() {
           if (this.readyState == 4 && this.status == 200) {
               ...
               document.getElementById("txt_Usuario_Nombre").value=l_Valor1;
