...
function fn_Ambiente_Modulos_Listado_Clic(l_CondicionExtra){
    ...
    // Limpia la información
    l_CondicionExtra=l_CondicionExtra.trim();
    ...
    // Procesar
    var arreglo=new Array();
    arreglo.push( { "consulta":l_Consulta,"condicion":l_CondicionExtra,"tipo":"general", "campos":"definidos","campodeordenamiento": "", "formadeordenamiento":FORMA_ORDENAMIENTO, "cantidadregistros":NUMERODEREGISTROS,"modulo":MODULO  } );     

    if(arreglo.length>0){       
        // Enviar para procesdar
        resultado=Listado_Modulos(arreglo); 
    } else {
        console.log("ERROR NO SE CARGO LA INFORMACIÓN");
    }
}
...
function fn_Consultar_Clic(l_Consulta){     
   ...
   if(l_Consulta.length<=0){
    ...
    // Procesar
    var arreglo=new Array();
    arreglo.push( { "consulta":"","condicion":l_Consulta,"tipo":"general", "campos":"definidos","campodeordenamiento": CAMPO_ORDENAMIENTO, "formadeordenamiento":FORMA_ORDENAMIENTO, "cantidadregistros":NUMERODEREGISTROS,"modulo":MODULO } );     
...
// 08/04/2020
function fn_Ambiente_Modulos_Clic(l_Consulta,l_Seleccion,l_Accion){     
    // Verificaciones
    if(l_Consulta.length<=0){
        console.log("ERROR NO TIENE CONSULTA");        
    } 
    ...
    if(arreglo.length>0){       
        // Enviar para procesdar
        resultado=Ambiente_Modulos_Combo(arreglo);
    } else {
        console.log("ERROR NO SE CARGO LA INFORMACIÓN");
    }
}
...
function fn_Ambiente_Modulos_Padre_Clic(l_Consulta){ 
    ...
    if(arreglo.length>0){       
        // Enviar para procesdar
        resultado=Ambiente_Modulos_Combo_Padre(arreglo); 
