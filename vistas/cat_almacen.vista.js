...
function fn_Cat_Almacen_Clic(l_Consulta,l_Seleccion,l_Accion){     
    // Verificaciones
...
function fn_Cat_Almacen_Origen_Clic(l_Consulta,l_Seleccion,l_Accion){     
    // Verificaciones
    if(l_Consulta.length<=0){
        console.log("ERROR NO TIENE CONSULTA");
        //return;
    ...
    if(arreglo.length>0){       
        // Enviar para procesdar
        resultado=Cat_Almacen_Combo_Origen(arreglo); 
    } else {
        console.log("ERROR NO SE CARGO LA INFORMACIÓN");
    }
}

function fn_Cat_Almacen_Destino_Clic(l_Consulta,l_Seleccion,l_Accion){     
   // Verificaciones
    if(l_Consulta.length<=0){
        console.log("ERROR NO TIENE CONSULTA");
        //return;
    ...
    if(arreglo.length>0){       
        // Enviar para procesdar
        resultado=Cat_Almacen_Combo_Destino(arreglo); 
    } else {
        console.log("ERROR NO SE CARGO LA INFORMACIÓN");
    }
}
...
function fn_Cat_Almacen_PorCentroDeServicio_Clic(){   
    var l_nID= document.getElementById("cb_nIDCat_CentroDeServicio").value;
    var l_Consulta="";

    if(l_nID>0){
        l_Consulta="nIDCat_CentroDeServicio=" + l_nID + " and bEstado=0";    
    }  
    ...
    // Procesar
    var arreglo=new Array();
    arreglo.push( { "condicion":l_Consulta, "tipo":"directa", "campos":"todos","campodeordenamiento": "", "formadeordenamiento":FORMA_ORDENAMIENTO,"cantidadregistros":NUMERODEREGISTROS } );     
...
function fn_Cat_Almacen_Inspeccion_Clic(l_Consulta,l_Seleccion,l_Accion){     
    // Verificaciones
    if(l_Consulta.length<=0){
        console.log("ERROR NO TIENE CONSULTA");
        //return;
    ...
    if(arreglo.length>0){       
        // Enviar para procesdar
        resultado=Cat_Almacen_Combo_Inspeccion(arreglo); 
    } else {
        console.log("ERROR NO SE CARGO LA INFORMACIÓN");
    }
}
