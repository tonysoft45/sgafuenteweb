// ----------------------------------------------------------------------------------
// cat_centrosdeservicio.vista.js
// ----------------------------------------------------------------------------------
...
function fn_Listado_Clic(){
    ...
    arreglo.push( { "condicion":l_Consulta,"tipo":"general", "campos":"definidos","campodeordenamiento": CAMPO_ORDENAMIENTO, "formadeordenamiento":FORMA_ORDENAMIENTO,"cantidadregistros":NUMERODEREGISTROS} );     
...
function fn_Cat_CentrosDeServicio_Clic(l_Consulta,l_Seleccion,l_Accion){     
    // Verificaciones
    if(l_Consulta.length<=0){
    ...
    if(arreglo.length>0){       
        // Enviar para procesdar
        resultado=Cat_CentrosDeServicio_Combo(arreglo); 
    } else {
        console.log("ERROR NO SE CARGO LA INFORMACIÓN");
    }
}
...
function fn_Consultar_Clic(l_Consulta){     
    ...
    // Procesar
    var arreglo=new Array();
    arreglo.push( { "condicion":l_Consulta, "tipo":"directa", "campos":"todos","campodeordenamiento": CAMPO_ORDENAMIENTO, "formadeordenamiento":FORMA_ORDENAMIENTO,"cantidadregistros":NUMERODEREGISTROS, "modulo":MODULO } );    
