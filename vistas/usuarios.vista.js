...
function fn_Usuarios_Clic(l_Consulta,l_Seleccion,l_Accion){     
     // Verificaciones
     if(l_Consulta.length<=0){
        console.log("ERROR NO TIENE CONSULTA");
        //return;
...
function fn_Comprador_Clic(l_Consulta,l_Seleccion,l_Accion){      
    // Verificaciones
    if(l_Consulta.length<=0){
        console.log("ERROR NO TIENE CONSULTA");
        //return;
    ...
    if(arreglo.length>0){       
        // Enviar para procesdar
        resultado=Comprador_Combo(arreglo); 
    } else {
        console.log("ERROR NO SE CARGO LA INFORMACIÓN");
    }
}
...
function fn_Usuarios_Nombre_Clic(l_Consulta,l_Seleccion,l_Accion){    
     // Verificaciones
     if(l_Consulta.length<=0){
        console.log("ERROR NO TIENE CONSULTA");
        //return;
    ...
    if(arreglo.length>0){       
        // Enviar para procesdar
        resultado=Usuarios_Nombre(arreglo); 
    } else {
        console.log("ERROR NO SE CARGO LA INFORMACIÓN");
    }
}
